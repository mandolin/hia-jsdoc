 ...
 *
 * @param {object} [options] <lang zh-CN>HIA JSDoc preset 配置覆盖项。</lang><lang en>Configuration overrides for the HIA JSDoc preset.</lang>
 * @returns {object} <lang zh-CN>可直接写入 JSDoc config file 的配置对象。</lang><lang en>A configuration object that can be written directly to a JSDoc config file.</lang>
 * @throws {TypeError} <lang zh-CN>当 mode 不是已支持的 HIA JSDoc 模式时抛出。</lang><lang en>Thrown when mode is not a supported HIA JSDoc mode.</lang>
 ...
 *
 * @param {object} preset <lang zh-CN>由 HIA preset 生成的基础配置。</lang><lang en>The base configuration generated by the HIA preset.</lang>
 * @param {object} [userConfig] <lang zh-CN>使用者提供的 JSDoc 配置覆盖项。</lang><lang en>User-supplied JSDoc configuration overrides.</lang>
 * @returns {object} <lang zh-CN>合并后的 JSDoc 配置；插件数组会去重，HIA 子配置会逐层合并。</lang><lang en>The merged JSDoc config; plugin arrays are deduplicated and HIA sub-config is merged by section.</lang>
